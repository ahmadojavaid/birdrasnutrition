...
if ( ! class_exists( 'Kenzap_Plugin' ) ) {
    ...
    class Kenzap_Plugin{
        ...
        const KENZAP_PLUGIN_VERSION = '1.0.5';
        ...
        public function check_notice(){
            ...
            //enable disable ultimate memebr plugin
            if ( isset( $_GET['um'] ) ){
                if ( $_GET['um'] == 'true' ){
        ...
        static public function get_demo_style(){ ?>
            ...
            <?php if ( get_site_url() == 'http://wordpresss.'.basename( get_template_directory() ) || get_site_url() == 'http://'.basename( get_template_directory() ).'.kenzap.com' ){ ?>
                <style type="text/css">
                    /* install demo in cloud | THIS ONLY SHOWS UP IN OUR DEMO */
                    .kenzap_demo{
                        color:#ccc;
                        position:fixed;
        ...
        static public function get_demo_body(){ ?> 
            ...
            <?php if ( get_site_url() == 'http://wordpresss.'.basename( get_template_directory() ) || get_site_url() == 'http://'.basename( get_template_directory() ).'.kenzap.com' ){ ?>
                <a class="kenzap_demo" href="http://kenzap.com/signin/?project=<?php echo strtolower( basename( get_template_directory() ) ); ?>" target="blank" >FREE DEMO</a>  
            <?php } ?>
        <?php
        }
        ...
        static public function get_css_colors($colors_orr, $colors_typ, $colors_opa, $colors_arr, $css_rules){
            ...
            while ($i < sizeof($colors_opa)) {
                ...
                $id = $colors_arr[$i]; 
                if ( $colors_opa[$i] !== 0 ){
                    $id = sekolah_hex2rgba($colors_arr[$i], $colors_opa[$i]);
                }

                if ( $colors_typ[$i] !== 0 ){
                    $id = sekolah_adjust_brightness($colors_arr[$i], $colors_typ[$i]);
                }
